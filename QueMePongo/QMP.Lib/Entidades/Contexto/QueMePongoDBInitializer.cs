...
namespace Ar.UTN.QMP.Lib.Entidades.Contexto
{
    public class QueMePongoDBInitializer : DropCreateDatabaseIfModelChanges<QueMePongoDB>
    {
        protected override void Seed(QueMePongoDB context)
        {
            ...
            listaCar.Add(new Caracteristica("ABRIGO", "16"));
            listaCar.Add(new Caracteristica("ABRIGO", "17"));
            listaCar.Add(new Caracteristica("ABRIGO", "18"));
            listaCar.Add(new Caracteristica("ABRIGO", "19"));
            listaCar.Add(new Caracteristica("ABRIGO", "20"));
            listaCar.Add(new Caracteristica("ABRIGO", "21"));
            listaCar.Add(new Caracteristica("ABRIGO", "22"));
            listaCar.Add(new Caracteristica("ABRIGO", "23"));
            listaCar.Add(new Caracteristica("ABRIGO", "24"));
            listaCar.Add(new Caracteristica("ABRIGO", "25"));
            listaCar.Add(new Caracteristica("ABRIGO", "26"));
            listaCar.Add(new Caracteristica("ABRIGO", "27"));
            listaCar.Add(new Caracteristica("ABRIGO", "28"));
            listaCar.Add(new Caracteristica("ABRIGO", "29"));
            listaCar.Add(new Caracteristica("ABRIGO", "30"));
            listaCar.Add(new Caracteristica("ABRIGO", "31"));
            listaCar.Add(new Caracteristica("ABRIGO", "32"));
            listaCar.Add(new Caracteristica("ABRIGO", "33"));
            listaCar.Add(new Caracteristica("ABRIGO", "34"));
            listaCar.Add(new Caracteristica("ABRIGO", "35"));
            listaCar.Add(new Caracteristica("ABRIGO", "36"));
            listaCar.Add(new Caracteristica("ABRIGO", "37"));
            listaCar.Add(new Caracteristica("ABRIGO", "38"));
            listaCar.Add(new Caracteristica("ABRIGO", "39"));
            listaCar.Add(new Caracteristica("ABRIGO", "40"));
            listaCar.Add(new Caracteristica("ABRIGO", "41"));
            listaCar.Add(new Caracteristica("ABRIGO", "42"));
            listaCar.Add(new Caracteristica("ABRIGO", "43"));
            listaCar.Add(new Caracteristica("ABRIGO", "44"));
            listaCar.Add(new Caracteristica("ABRIGO", "45"));
            listaCar.Add(new Caracteristica("ABRIGO", "46"));
            listaCar.Add(new Caracteristica("ABRIGO", "47"));
            listaCar.Add(new Caracteristica("ABRIGO", "48"));
            listaCar.Add(new Caracteristica("ABRIGO", "49"));
            listaCar.Add(new Caracteristica("ABRIGO", "50"));
            listaCar.Add(new Caracteristica("ABRIGO", "51"));
            listaCar.Add(new Caracteristica("ABRIGO", "52"));
            listaCar.Add(new Caracteristica("ABRIGO", "53"));
            listaCar.Add(new Caracteristica("ABRIGO", "54"));
            listaCar.Add(new Caracteristica("ABRIGO", "55"));
            listaCar.Add(new Caracteristica("ABRIGO", "56"));
            listaCar.Add(new Caracteristica("ABRIGO", "57"));
            listaCar.Add(new Caracteristica("ABRIGO", "58"));
            listaCar.Add(new Caracteristica("ABRIGO", "59"));
            listaCar.Add(new Caracteristica("ABRIGO", "60"));
            listaCar.Add(new Caracteristica("ABRIGO", "61"));
            listaCar.Add(new Caracteristica("ABRIGO", "62"));
            listaCar.Add(new Caracteristica("ABRIGO", "63"));
            listaCar.Add(new Caracteristica("ABRIGO", "64"));
            listaCar.Add(new Caracteristica("ABRIGO", "65"));
            listaCar.Add(new Caracteristica("ABRIGO", "66"));
            listaCar.Add(new Caracteristica("ABRIGO", "67"));
            listaCar.Add(new Caracteristica("ABRIGO", "68"));
            listaCar.Add(new Caracteristica("ABRIGO", "69"));
            listaCar.Add(new Caracteristica("ABRIGO", "70"));
